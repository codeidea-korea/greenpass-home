...
<section class="main-top">
	<div class="container <?=!$chkMobile?'flex flex-middle':''?>">
		<div class="left wow fadeInRight" data-wow-duration="1s" data-wow-delay="0s">
			<?php if(!$chkMobile) echo '<img src="./img/img-logo.png">'; ?>
			...
			<div class="mt40 mtm15 flex flex-middle btnSet">
				<a href="#"><img src="./img/btn_app01.png"></a>
				<a href="#" class="ml20 mlm10"><img src="./img/btn_app02.png"></a>
			</div>
		</div>
	...
	<div class="container flex flex-middle mt300 mb250 mtm110 mbm80">
		...
		<div class="right">
			...
			<ul class="why-greenpass">
				<li>
					<div class="icon_img"><img src="./img/icon01.png"></div>
					<div class="content">
				...
				<li>
					<div class="icon_img"><img src="./img/icon02.png"></div>
					<div class="content">
				...
				<li>
					<div class="icon_img"><img src="./img/icon03.png"></div>
					<div class="content">
...
<section class="main-bl02" style="background:#F8F9FB;">
	<div class="container tcenter mt180 mb180 mtm100 mbm130">		
		...
		<img src="./img/img04.png" class="layer-img01 wow fadeInScale" data-wow-duration="1s" data-wow-delay="0s">
		<img src="./img/img05.png" class="layer-img02 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
		<img src="./img/img06.png" class="layer-img03 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.4s">
		<img src="./img/img07.png" class="layer-img04 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.6s">
		<img src="./img/img08.png" class="layer-img05 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
	</div>
</section>
...
<section class="main-bl03" style="background:#E6F2F2;">
	<div class="container tcenter mt200 mb200 mtm80 mbm80">
		...
		<div>
			<video src="./video/greenpass_video.mp4" class="video" controls  poster="./video/greenpass_video.png" style="width:100%;">﻿</video>
		</div>
	</div>
</section>
	...
	<div class="container mt200 mb200 mtm80 mbm80">
		...
		<ul>
			<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s">
				<div class="thumb"><img src="./img/icon04.png"></div>
				<div class="con">
					<p class="subject">간편한 1초 인증</p>
			...
			<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
				<div class="thumb"><img src="./img/icon05.png"></div>
				<div class="con">
			...
			<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
				<div class="thumb"><img src="./img/icon06.png"></div>
				<div class="con">
			...
			<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
				<div class="thumb"><img src="./img/icon07.png"></div>
				<div class="con">
...
<section class="main-bl05" style="background:#F6F9FC;">
	<div class="container tcenter mt200 mb200 mtm80 mbm80">
		...
		<ul class="companySet">
			<li><img src="./img/company01.png"></li>
			<li><img src="./img/company02.png"></li>
			<li><img src="./img/company03.png"></li>
			<li><img src="./img/company04.png"></li>
			<li><img src="./img/company05.png"></li>
			<li><img src="./img/company06.png"></li>
		</ul>
	</div>
</section>
...
<section class="main-bl07" style="background:url('./img/<?=!$chkMobile?'main-bl07-bg.png':'main-bl07-bg-mobile.png'?>') no-repeat center / cover;">
